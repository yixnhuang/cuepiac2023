...
extern "C"
{
	...
	namespace SimOneAPI {
		...
		*/
		...
		/*!
		Get the lane closest to the input point, the lane to which it belongs takes priority
		\li function:
		*	GetNearMostLane
		\li brief:
		...
		*/
		...
		/*!
		Get the list of adjacent lanes
		\li function:
		*	GetNearLanes
		\li brief:
		...
		*/
		...
		/*!
		Gets the distance to the left and right edge lines of the nearest lane
		\li function:
		...
		*/
		...
		/*!
		Get lane information (including lane ID, left and right edge lines, virtual center line)
		\li function:
		*	GetLaneSample
		\li brief:
		...
		*/
		...
		/*!
		Gets the ST coordinates relative to the virtual centerline of the lane
		\li function:
		*	GetLaneST
		\li brief:
		...
		*/
		...
		/*!
		Gets the ST coordinates relative to the road reference line
		\li function:
		*	GetRoadST
		\li brief:
		...
		*/
		...
		/*!
		Gets local coordinates based on lane ST coordinates
		\li function:
		...
		*/
		...
		/*!
		Query whether the specified lane exists in the map
		\li function:
		*	ContainsLane
		\li brief:
		...
		*/
		...
		/*!
		Get the list of parking spaces on the map
		\li function:
		*	GetParkingSpaceList
		\li brief:
		...
		*/
		...
		/*!
		Get the ID list of roads along the planned route
		\li function:
		*	Navigate
		\li brief:
		...
		*/
		...
		/*!
		Obtains the lane marking information on the left and right sides of the input point based on the specified lane id and local coordinates
		\li function:
		*	GetRoadMark
		\li brief:
		...
		*/
		...
		/*!
		Get the list of signal lights in the map
		\li function:
		*	GetTrafficLightList
		\li brief:
		...
		*/
		...
		/*!
		Get the list of traffic signs in the map
		\li function:
		*	GetTrafficSignList
		\li brief:
		...
		*/
		...
		/*!
		Gets the list of associated stop lines for a given traffic light lane
		\li function:
		*	GetStoplineList
		\li brief:
		...
		*/
		...
		/*!
		Gets the list of associated crosswalk lines for a given traffic light lane
		\li function:
		*	GetCrosswalkList
		\li brief:
		...
		*/
		...
		/*!
		Get the list of mesh lines on the road where the specified lane is located
		\li function:
		*	GetCrossHatchList
		\li brief:
		...
		*/
		...
		/*!
		Get the point and tangent direction of the input point projected onto the center line of the specified lane
		\li function:
		*	GetLaneMiddlePoint
		\li brief:
		...
		*/
		...
		/*!
		Get the elevation list of specified coordinate points on the road network
		\li function:
		*	GetHeights
		\li brief:
		...
		*/
		...
		/*!
		Gets a list of all Junction IDs.
		\li function:
		*	GetJunctionList
		\li brief:
		...
		*/
		...
		/*!
		Gets the list of all lane IDs in the Section where the specified lane line is located.
		\li function:
		*	GetSectionLaneList
		\li brief:
		...
		*/
		...
		/*!
		Determines whether the specified road is a two-way road
		\li function:
		*	IsTwoSideRoad
		\li brief:
		...
		*/
		...
		/*!
		Determine whether the lane is a motor vehicle lane
		\li function:
		*	IsDriving
		\li brief:
		...
		*/
		...
		/*!
		Determine whether the lane is within the intersection
		\li function:
		*	IsInJunction
		\li brief:
		...
		*/
		...
		/*!
		Determines whether the coordinate point is within the lane
		\li function:
		*	IsInsideLane
		\li brief:
		*	Check whether current lane belongs to a junction.
		...
		*/
		...
		// %%%%%%%%%%%% V3 Add %%%%%%%%%%%%
		/*!
		Get the lane information where the main vehicle is located (including lane ID, left and right edge lines, virtual center line)
		\li function:
		...
		*/
		...
		/*!
		Gets a list of associated crosswalk lines for a given lane
		\li function:
		...
		*/
		...
		/*!
		Gets the list of associated stop lines for a given lane
		\li function:
		...
		*/
		...
		/*!
		Gets the list of signals bound to the specified lane
		\li function:
		...
		*/
		...
		/*!
		Get the list of parking spaces at a certain distance in front of the specified point on the map
		\li function:
		*	GetParkingSpaceIds
		\li brief:
		...
		*/
		...
		/*!
		Get all lane information within a certain distance ahead (including lane ID, left and right edge lines, virtual center line)
		\li function:
		...
		*/
		...
		/*!
		Obtains the lane indication information and ground markings of the specified road through the signal type (type="Graphics")
		\li function:
		...
		*/
		...
		/*!
		Gets all lane names within the specified road ID
		\li function:
		*	GetLaneList
		\li brief:
		...
		*/
		...
		/*!
		Obtain detailed information of road network path planning
		\li function:
		*	GenerateRoute_V2
		\li brief:
