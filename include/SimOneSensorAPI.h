...
extern "C"
{
	...
	namespace SimOneAPI {
		...
		*/
		...
		/*!
		Main vehicle GPS update callback
		\li function:
		*	SetGpsUpdateCB
		\li brief:
		...
		*/
		...
		/*!
		Get current environment-related information (weather, lighting, ground, etc.)
		\li function:
		*	GetEnvironment
		\li brief:
		...
		*/
		...
		/*!
		Get the lane and lane line data detected by the sensor
		\li function:
		*	GetSensorLaneInfo
		\li brief:
		...
		*/
		...
		/*!
		Get the sensor detected lane and lane line data callback
		\li function:
		*	SetSensorLaneInfoCB
		\li brief:
		...
		*/
		...
		/*!
		Get road-marking data detected by the sensor, including stop lines, directional arrows, and crosswalk lines
		\li function:
		...
		*/
		...
		/*!
		Callback for road-marking data detected by the sensor, including stop lines, directional arrows, and crosswalk lines
		\li function:
