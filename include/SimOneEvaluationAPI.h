...
extern "C"
{
	...
	namespace SimOneAPI{
		...
		*/
		...
		/*!
		Initialize evaluation service, store data locally
		\li function:
		*	InitEvaluationService
		\li brief:
		*	Initialize Evaluation Service for autonomous driving algorithm
		...
		*/
		...
		/*!
		Add various information required for the evaluation algorithm (JSON format)
		\li function:
		*	AddEvaluationRecord
		\li brief:
		...
		*/
		...
		/*!
		Saves various information required for the evaluation algorithm (JSON format)
		\li function:
		...
		*/
		...
		/*!
		Scene determination event callback
		\li function:
		*	SetJudgeEventCB
		\li brief:
