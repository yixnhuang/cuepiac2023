...
extern "C"
{
	...
	namespace SimOneAPI {
		...
		/*!
		Obtains the v2x message after UPER encoding in the corresponding vehicle number V2X
		\li function:
		*	GetV2XInfo
		\li brief:
		...
		*/
		...
		/*!
		Get the v2x message update callback after obtaining the UPER code in the corresponding vehicle number V2X
		\li function:
		*	SetV2XInfoUpdateCB
		\li brief:
