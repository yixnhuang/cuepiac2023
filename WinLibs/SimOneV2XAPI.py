...
def SoGetV2XInfo(mainVehicleId, sensorId, infoType, detectionData):
	"""Get the v2x message after the UPER encoding in the corresponding vehicle number V2X.
...
def SoApiSetV2XInfoUpdateCB(cb):
	"""V2x message update callback after obtaining the UPER code in the corresponding vehicle number V2X.
